...
export function SchoolDetail({ id }: SchoolDetailProps) {
  ...
  return (
    <div className="min-h-screen bg-[#0F0F0F]">
      {/* Sticky header */}
      <div className="sticky top-0 z-10 border-b border-[#2a2a2a] bg-[#0F0F0F]/95 px-4 py-3 backdrop-blur-sm md:px-6">
        <div className="flex items-center gap-3">
          <Link href="/schools">
            <button className="rounded-md p-1.5 text-[#6E6E73] hover:bg-[#1f1f1f] hover:text-[#F2F2F2]">
              <ArrowLeft className="h-4 w-4" />
            </button>
          </Link>
          <div className="min-w-0 flex-1">
            <h1 className="truncate text-lg font-semibold text-[#F2F2F2]">{school.name}</h1>
          ...
          <button
            ...
            className="rounded-md bg-[#6247AA] px-3 py-1.5 text-xs font-medium text-white hover:bg-[#5239A1]"
          >
            Log Activity
          </button>
        </div>
      ...
      <div className="space-y-0 px-4 py-6 md:px-6">
        ...
        <section className="pb-6">
          <h2 className="mb-4 text-xs font-semibold tracking-wider text-[#6E6E73] uppercase">
            School Info
          </h2>
          ...
          <div className="mb-4 grid grid-cols-2 gap-3 sm:grid-cols-4">
            {school.studentCount != null && (
              <div className="rounded-lg border border-[#2a2a2a] bg-[#161617] p-3">
                <div className="flex items-center gap-1.5 text-[#6E6E73]">
                  <Users className="h-3.5 w-3.5" />
                  <span className="text-xs">Enrollment</span>
                </div>
                <p className="mt-1 text-lg font-semibold text-[#F2F2F2]">
            ...
            {school.gradeRange && (
              <div className="rounded-lg border border-[#2a2a2a] bg-[#161617] p-3">
                ...
                <p className="mt-1 text-lg font-semibold text-[#F2F2F2]">{school.gradeRange}</p>
              </div>
            )}
            <div className="rounded-lg border border-[#2a2a2a] bg-[#161617] p-3">
              <div className="flex items-center gap-1.5 text-[#6E6E73]">
              ...
              <p className="mt-1 text-sm font-semibold text-[#F2F2F2]">{school.schoolType}</p>
            </div>
            {school.district && (
              <div className="rounded-lg border border-[#2a2a2a] bg-[#161617] p-3">
                <div className="flex items-center gap-1.5 text-[#6E6E73]">
                ...
                <p className="mt-1 truncate text-sm font-medium text-[#F2F2F2]">
          ...
          <div className="flex flex-col gap-2 text-sm">
            {school.address && (
              <div className="flex items-start gap-2 text-[#F2F2F2]">
            ...
            {school.phone && (
              <div className="flex items-center gap-2 text-[#F2F2F2]">
                ...
                <a href={`tel:${school.phone}`} className="hover:text-[#CABDFD]">
                  {school.phone}
                </a>
              </div>
            )}
            {school.email && (
              <div className="flex items-center gap-2 text-[#F2F2F2]">
                ...
                <a href={`mailto:${school.email}`} className="truncate hover:text-[#CABDFD]">
                  {school.email}
                </a>
              </div>
            )}
            {/* Website — editable */}
            <div className="flex items-center gap-2 text-[#F2F2F2]">
              <Globe className="h-4 w-4 flex-shrink-0 text-[#6E6E73]" />
              {isEditingWebsite ? (
                <div className="flex flex-1 items-center gap-2">
                  <Input
                    ...
                    className="h-7 flex-1 border-[#2a2a2a] bg-[#2a2a2a] text-sm text-[#F2F2F2] placeholder:text-[#6E6E73]"
                    onKeyDown={(e) => {
                  ...
                  <Button
                    ...
                    className="h-7 w-7 p-0 text-[#6E6E73] hover:text-[#F2F2F2]"
                  >
                ...
                <div className="flex flex-1 items-center gap-2">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="flex items-center gap-1 truncate hover:text-[#CABDFD]"
                  >
                    {school.website}
                  ...
                  <Button
                    ...
                    className="h-6 w-6 p-0 text-[#6E6E73] hover:text-[#F2F2F2]"
                  >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Button
                    ...
                    className="h-6 px-2 text-xs text-[#6E6E73] hover:text-[#CABDFD]"
                  >
            ...
            {school.techStack && (
              <div className="flex items-center gap-2">
                <span className="text-xs tracking-wider text-[#6E6E73] uppercase">Tech Stack:</span>
          ...
          <Form {...pipelineForm}>
            ...
            >
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-[#6E6E73]">Stage</FormLabel>
                    <Select onValueChange={field.onChange} value={field.value}>
                      <FormControl>
                        <SelectTrigger className="border-[#2a2a2a] bg-[#2a2a2a] text-[#F2F2F2]">
                          <SelectValue />
                        </SelectTrigger>
                      </FormControl>
                      <SelectContent className="border-[#2a2a2a] bg-[#1f1f1f]">
                        {PIPELINE_STAGES.map((s) => (
                          <SelectItem key={s.value} value={s.value} className="text-[#F2F2F2]">
                            {s.label}
                          </SelectItem>
                        ))}
                      </SelectContent>
              ...
              <div className="grid grid-cols-2 gap-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-[#6E6E73]">Last Contacted</FormLabel>
                      <FormControl>
                        <Input
                          {...field}
                          type="date"
                          className="border-[#2a2a2a] bg-[#2a2a2a] text-[#F2F2F2]"
                        />
                      </FormControl>
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-[#6E6E73]">Next Follow-up</FormLabel>
                      <FormControl>
                        <Input
                          {...field}
                          type="date"
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-[#6E6E73]">Notes</FormLabel>
                    <FormControl>
                      <Textarea
                        {...field}
                        className="border-[#2a2a2a] bg-[#2a2a2a] text-[#F2F2F2] placeholder:text-[#6E6E73]"
                        rows={3}
        ...
        <section className="py-6">
          <div className="mb-4 flex items-center justify-between">
            <h2 className="text-xs font-semibold tracking-wider text-[#6E6E73] uppercase">
              Contacts
              {school.contacts.length > 0 && (
                <span className="ml-2 text-[#CABDFD] normal-case">({school.contacts.length})</span>
              )}
            </h2>
            <button
              onClick={() => setShowAddContact(true)}
              className="text-xs text-[#CABDFD] hover:text-[#6247AA]"
            >
              + Add
            </button>
          </div>
          {school.contacts.length === 0 ? (
            <p className="text-sm text-[#6E6E73]">No contacts yet.</p>
          ) : (
            <div className="flex flex-col gap-2">
              {school.contacts.map((contact) => (
                <div
                  key={contact.id}
                  className="rounded-lg border border-[#2a2a2a] bg-[#161617] p-3"
                >
                  <div className="flex items-center gap-2">
                    <span className="font-medium text-[#F2F2F2]">{contact.name}</span>
                    {contact.isPrimary && (
                      <Badge className="h-4 bg-[#6247AA]/20 px-1.5 text-[10px] text-[#CABDFD]">
                        Primary
                      </Badge>
                    )}
                  </div>
                  {contact.title && <p className="text-xs text-[#6E6E73]">{contact.title}</p>}
                  <div className="mt-1 flex flex-wrap gap-3 text-xs text-[#6E6E73]">
                    {contact.email && (
                      <a href={`mailto:${contact.email}`} className="hover:text-[#CABDFD]">
                        {contact.email}
                      </a>
                    )}
                    {contact.phone && (
                      <a href={`tel:${contact.phone}`} className="hover:text-[#CABDFD]">
                        {contact.phone}
                      </a>
                    )}
                  </div>
        ...
        <section className="py-6">
          <div className="mb-4 flex items-center justify-between">
            <h2 className="text-xs font-semibold tracking-wider text-[#6E6E73] uppercase">
              ...
              {school.outreachLogs.length > 0 && (
                <span className="ml-2 text-[#CABDFD] normal-case">
          ...
          {school.outreachLogs.length === 0 ? (
            <p className="text-sm text-[#6E6E73]">No outreach recorded yet.</p>
          ) : (
            <div className="flex flex-col gap-2">
              {school.outreachLogs.map((log) => (
                <div
                  key={log.id}
                  className="rounded-lg border border-[#2a2a2a] bg-[#161617] p-3 text-sm"
                >
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex flex-wrap items-center gap-2">
                        <span className="font-medium text-[#F2F2F2] capitalize">
                          {log.type.toLowerCase()}
                        </span>
                        <Badge
                          variant="outline"
                          className="h-4 border-[#2a2a2a] px-1.5 text-[10px] text-[#6E6E73]"
                        >
                          {log.outcome != null
                        ...
                        {log.contact && (
                          <span className="text-[#6E6E73]">with {log.contact.name}</span>
                        )}
                      </div>
                      {log.subject && <p className="mt-0.5 text-[#6E6E73]">{log.subject}</p>}
                      {log.notes && (
                        <p className="mt-1 line-clamp-2 text-xs text-[#6E6E73]">{log.notes}</p>
                      )}
                    </div>
                    <div className="flex flex-shrink-0 items-center gap-1 text-xs text-[#6E6E73]">
